...
namespace VitalLink.Repositories.Base;

public class EfBaseRepository<TEntity> : EfCoreRepository<VitalLinkDbContext, TEntity, Guid>,
    IBaseRepository<TEntity>
    where TEntity : class, IEntity<Guid>
{
    public EfBaseRepository(IDbContextProvider<VitalLinkDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
