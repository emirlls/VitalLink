...
namespace VitalLink.Services.Auth;

public class AuthAppService : VitalLinkAppService, IAuthAppService
{
    ...
    private IStringLocalizer<VitalLinkResource> StringLocalizer =>
        LazyServiceProvider.LazyGetRequiredService<IStringLocalizer<VitalLinkResource>>();
