...
namespace VitalLink.Middlewares;

public class GenericResponseMiddleware
{
    private readonly IStringLocalizer<VitalLinkResource> _localizer;
    private readonly RequestDelegate _next;

    public GenericResponseMiddleware(RequestDelegate next, IStringLocalizer<VitalLinkResource> localizer)
    {
        _next = next;
